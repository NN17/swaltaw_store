<div class="ui clearing segment">
	<h3 class="ui left floated header teal"><?=$this->lang->line('customer')?></h3>
	<a href="new-customer" class="ui button right floated teal"><i class="ui icon plus circle"></i> New</a>
</div>
