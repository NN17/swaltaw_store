<div class="ui clearing segment orange">
	...
	<a href="create-discount" class="ui button right floated orange <?=$this->auth->checkModify($this->session->userdata('Id'), 'discounts')?'':'disabled'?>">
	...
	<tbody>
		...
		?>
			<tr>
				...
				<td>
					<a href="modify-discount/<?=$discount->discountId?>" class="ui button icon circular orange <?=$this->auth->checkModify($this->session->userdata('Id'), 'discounts')?'':'disabled'?>"><i class="icon cog"></i></a>
					<a href="javascript:void(0)" class="ui button icon circular red <?=$this->auth->checkModify($this->session->userdata('Id'), 'discounts')?'':'disabled'?>" id="delete" data-url="delete-discount/<?=$discount->discountId?>"><i class="icon remove"></i></a>
				</td>
			</tr>
		<?php 
			$i++;
